...
export default function Knowledge() {
    return (
        <div className="max-w-4xl mx-auto py-6 px-4 space-y-6 animate-in fade-in duration-500">
            <div>
                <h1 className="text-2xl font-bold text-zinc-100 mb-2">Knowledge Bank</h1>
                <p className="text-zinc-400 text-sm">Your accumulated skills and learnings over time.</p>
            </div>

            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="bg-zinc-900/50 border border-zinc-800 rounded-xl p-1 md:col-span-2">
                    <LearnedBank />
                </div>
