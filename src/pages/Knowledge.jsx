    ...
    return (
        <div className="max-w-4xl mx-auto py-6 px-4 space-y-6 animate-in fade-in duration-500">
            <div>
                ...
                <p className="text-zinc-500 dark:text-zinc-400 text-sm">Your accumulated skills and learnings over time.</p>
            </div>

            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="bg-transparent border-0 rounded-xl p-1 md:col-span-2">
                    <LearnedBank />
                </div>

                {/* Future: Bookmarked Logs, Resources, etc. */}
                <div className="border border-dashed border-gray-300 dark:border-zinc-800 rounded-xl p-8 text-center text-zinc-400 dark:text-zinc-500 text-sm">
